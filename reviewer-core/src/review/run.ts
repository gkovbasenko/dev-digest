...
export interface ReviewInput {
  ...
  /**
   * Derived PR intent/scope summary (untrusted; delimiter-wrapped in the
   * prompt with an on-scope rule appended). Caller pre-renders it (e.g. from
   * the stored `Intent` record). Empty/undefined → section omitted.
   */
  intent?: string;
